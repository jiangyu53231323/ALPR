...
from nets.scrnet_esnet import SCRNet_Pico
from nets.scrnet_ghostnet import SCRNet_ghost
...
parser.add_argument('--log_name', type=str, default='scr_coco_ghostnet_64x224_se_cfp_rectify')
